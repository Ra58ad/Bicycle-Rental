...
public class Manager extends JFrame implements ActionListener {
    ...
    public Manager() {
        ...
        b1.addActionListener(e -> {
            ...
            if (table.equalsIgnoreCase("bicycle")) {
                ...
                String phone = JOptionPane.showInputDialog(this, "Enter phone:");
                String password = JOptionPane.showInputDialog(this, "Enter password:");
                String role = JOptionPane.showInputDialog(this, "Enter password:");
                String manId = JOptionPane.showInputDialog(this, "Enter Manager ID: ");
                if (name != null && !name.isEmpty()) {
                    insertStaff(name, email, phone, password, role, manId);
                }
            } else if(table.equalsIgnoreCase("supplier")) {
                String name = JOptionPane.showInputDialog(this, "Enter name:");
                String compName = JOptionPane.showInputDialog(this, "Enter company name");
                String email = JOptionPane.showInputDialog(this, "Enter email:");
                String phone = JOptionPane.showInputDialog(this, "Enter phone:");
                if (name != null && !name.isEmpty()) {
                    insertSupplier(name, compName, email, phone);
                }
            } else {
                LocalDate temp = LocalDate.now();
        ...
        b2.addActionListener(e -> {
            ...
            if (table.equalsIgnoreCase("bicycle")) {
                ...
                String manId = JOptionPane.showInputDialog(this, "Enter Manager ID: ");
                if (name != null && !name.isEmpty()) {
                    updateStaff(name, email, phone, password, role, manId, ID);
                }
            } else if(table.equalsIgnoreCase("supplier")) {
                int ID = Integer.parseInt(JOptionPane.showInputDialog(this, "Enter ID:"));
                String name = JOptionPane.showInputDialog(this, "Enter name:");
                ...
                String phone = JOptionPane.showInputDialog(this, "Enter phone:");
                if (name != null && !name.isEmpty()) {
                    updateSupplier(name, compName, email, phone, ID);
                }
            } else {
                int ID = Integer.parseInt(JOptionPane.showInputDialog(this, "Enter ID:"));
                LocalDate temp = LocalDate.now();
    ...
    private void insertStaff(String name, String email, String phone, String password, String role, String managerIdStr) {
        String sql = "INSERT INTO staff (full_name, email, phone, password, role, manager_id) VALUES (?, ?, ?, ?, ?, ?)";
        try (Connection conn = db.getConnection();
            PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setString(1, name);
            stmt.setString(2, email);
            ...
            stmt.setInt(6, Integer.parseInt(managerIdStr));
            stmt.executeUpdate();
            JOptionPane.showMessageDialog(this, "Inserted into staff");
        } catch (SQLException | NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "Insert failed: " + ex.getMessage());
        }
    }

    private void updateStaff(String name, String email, String phone, String password, String role, String managerIdStr, int id) {
        String sql = "UPDATE staff SET full_name=?, email=?, phone=?, password=?, role=?, manager_id=? WHERE staff_id=?";
        try (Connection conn = db.getConnection();
            PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setString(1, name);
            stmt.setString(2, email);
            ...
            stmt.setInt(7, id);
            stmt.executeUpdate();
            JOptionPane.showMessageDialog(this, "Updated staff");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, "Update failed: " + ex.getMessage());
        }
    }
    ...
    private void insertSupplier(String name,String comName, String email, String phone) {
        String sql = "INSERT INTO supplier (name, company_name, email, phone) VALUES (?, ?, ?, ?)";
        try (Connection conn = db.getConnection();
            PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setString(1, name);
            ...
            stmt.executeUpdate();
            JOptionPane.showMessageDialog(this, "Inserted into supplier");
        } catch (SQLException | NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "Insert failed: " + ex.getMessage());
        }
    }

    private void updateSupplier(String name, String comName, String email, String phone, int id) {
        String sql = "UPDATE supplier SET name=?, company_name=?, email=?, phone=? WHERE supplier_id=?";
        try (Connection conn = db.getConnection();
            PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setString(1, name);
            stmt.setString(2, comName);
            ...
            stmt.setInt(5, id);
            stmt.executeUpdate();
            JOptionPane.showMessageDialog(this, "Updated supplier");
        } catch (SQLException | NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "Update failed: " + ex.getMessage());
        }
    }
